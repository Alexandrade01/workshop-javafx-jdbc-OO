...
public class MovimentoFinanceiroEntradasFormController implements Initializable {
	...
	public void setServices(MovimentoFinanceiroService MovimentoFinanceiroService, CategoriaService categoriaService, MeioPagamentoService meioPagamentoService) {
	...
	private void initializeComboBoxEntradas() {
	...
	public void loadAssociatedObjects() {
		...
		List<Categoria> listCategoria = categoriaService.findAllDepositByUserId(usuarioId);
		...
		List<MeioPagamento> list = meioPagamentoService.findByUserId(usuarioId);
